...
public class KafkaSinkProducerFactory {

    public KafkaSinkProducer createProducer(final KafkaSinkConfig kafkaSinkConfig, final PluginFactory pluginFactory, final PluginSetting pluginSetting,
    ...
    private void prepareTopicAndSchema(final KafkaSinkConfig kafkaSinkConfig) {
    ...
    private void checkTopicCreationCriteriaAndCreateTopic(final KafkaSinkConfig kafkaSinkConfig) {
